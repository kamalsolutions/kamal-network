    ...
    <div class="grid lg:grid-cols-2 gap-10 p-10" id="contact">
        ...
        <div class="lg:mx-5 items-center align-center  lg:my-auto">
            ...
            <div class="flex my-4"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 " viewBox="0 0 20 20" fill="currentColor">
                ...
                </svg><span class="px-2 text-xl"> 55, 4th Avenue GREDA ESTATES Teshie-Nungua</span></div>
            <div class="flex my-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M7 2a2 2 0 00-2 2v12a2 2 0 002 2h6a2 2 0 002-2V4a2 2 0 00-2-2H7zm3 14a1 1 0 100-2 1 1 0 000 2z" clip-rule="evenodd" />
                </svg>
                <a href="tel:+233266328115" class="px-2 text-xl">+233266328115</a>
            </div>
            <div class="flex my-4">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path fill-rule="evenodd" d="M14.243 5.757a6 6 0 10-.986 9.284 1 1 0 111.087 1.678A8 8 0 1118 10a3 3 0 01-4.8 2.401A4 4 0 1114 10a1 1 0 102 0c0-1.537-.586-3.07-1.757-4.243zM12 10a2 2 0 10-4 0 2 2 0 004 0z" clip-rule="evenodd" />
                </svg>
                <a href="mailto:kamalnetworkgh@gmail.com" class="px-2 text-xl">kamalnetworkgh@gmail.com</a>
            </div>
        </div>
    </div>
</template>
